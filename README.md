...
* What the developer sees on their screen when they do `console.log(someFunction)`.
* What the developer sees on their screen when they look at the source code or network-response panels of devtools.
* What error stack traces the developer sees on their screen when an unhandled exception or rejection occurs.
